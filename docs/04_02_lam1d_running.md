...
A working example parameter file (`parameters_ex.json`) is provided in the [PFS-LAM1D-Installation](https://github.com/Subaru-PFS/pfs_helpdesk_tutorial/tree/main/PFS-LAM1D-Installation) folder of this repository. It explicitly sets only three parameters:
